AddRemoteEvent("Exucute", function(playerid, json)
    ...
    if(func == 'action_health_armor') then
    ...
    if(func == 'action_food_thirst') then
        if(isnil(data['target'])) then
            AddPlayerChat(playerid, "none id")
        else
    ...
    if(func == 'action_give_remove_item') then
    ...
    if(func == 'action_cache_remove') then
        if(isnil(data['target'])) then
            AddPlayerChat(playerid, "none id")
        else
            local target = data['target']
    ...
    if(func == 'action_change_time') then
