...
function krusty(player)
	TeleportTo(player, -168504.828125, -34338.8125, 1251.7052001953, 270)
end
AddCommand("krusty", krusty)


function npc(player)
	TeleportTo(player, 128959.1015625, 79325.328125, 1579.2750244141, 84.066261291504, 270)
end
AddCommand("npc", npc)
