...
_RequestSql = {
    ...
    GetPlayerAccount = "SELECT accounts.id, steam_id, health, armor, player_name, cash, cash_account, inventory, weight, account_administrator.admin_level FROM account_administrator RIGHT JOIN accounts ON account_administrator.account_id = accounts.id WHERE steam_id = '?';",
